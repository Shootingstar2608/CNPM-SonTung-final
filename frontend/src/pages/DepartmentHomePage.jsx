...
const DepartmentHomePage = () => {
  ...
  const avatarLabel = (localStorage.getItem('user_data') ? JSON.parse(localStorage.getItem('user_data')).name : 'D').charAt(0).toUpperCase();
    ...
    <div className="min-h-screen bg-white text-gray-900">
      <header className="border-b bg-white sticky top-0 z-30">
        <div className="max-w-6xl mx-auto h-16 px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          <button onClick={() => navigate('/department-home')} className="flex items-center gap-2">
          ...
          <nav className="hidden md:flex items-center gap-5">
            ...
            <button onClick={() => navigate('/department-stats')} className={`text-sm font-semibold py-1 text-gray-700 hover:text-blue-600`}>Thống kê</button>
          </nav>
